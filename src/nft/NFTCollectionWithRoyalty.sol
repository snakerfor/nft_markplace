 ...
 */
contract NFTCollectionWithRoyalty is ERC721, ERC721URIStorage, Ownable, IERC2981 {
     ...
     */
    constructor(address royaltyReceiver_, uint96 royaltyBps_) ERC721("MyNFTWithRoyalty", "MNFR") Ownable(msg.sender) {
